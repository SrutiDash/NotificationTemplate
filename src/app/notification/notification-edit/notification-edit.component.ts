...
//   selectOption(option: string) {
//     this.search = option; // This sets the selected value to the search input box
//     this.notification.parameters[0].body = option; // Set the body or whatever field you need to set
//     this.notification.parameters[0].header = this.notification.eventTrigger;
//     this.showParameterOptions = false;
//     this.filteredParameters = [];
//   }
...
//     this.notification.parameters[0].body = option; // Set the body or whatever field you need to set
//     this.notification.parameters[0].header = this.notification.eventTrigger;
//     this.showParameterOptions = false; // Hide dropdown after selection
//   }
