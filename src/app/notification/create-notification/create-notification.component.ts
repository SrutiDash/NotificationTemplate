...
//     return this.selectedServiceType !== '' && this.selectedEventTrigger !== '' && this.selectedParty !== '';
//   }
...
//   next() {
//     // Navigate to the Review and Confirm page
...
//     this.dataService.inAppSmsNotifications = this.inAppSmsNotifications;
...
//   // Added properties for notifications
