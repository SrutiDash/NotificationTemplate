...
// import { NotificationReviewConfirmComponent } from './notification/notification-review-confirm/notification-review-confirm.component';  // Import NotificationDetailsComponent
...
//     NotificationReviewConfirmComponent,  // Add NotificationDetailsComponent
//   ],
//   imports: [
//     BrowserModule,
//     AppRoutingModule,
...
@NgModule({
  declarations: [
    ...
    PaginatorComponent,
    NotificationDetailsComponent,
    NotificationReviewConfirmComponent,  // Add NotificationReviewConfirmComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
